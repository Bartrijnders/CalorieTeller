...
public class StandaardDagCollectie {
    ...
    public DagDTO getToday(){
        return new StandaardDagDTO(dagDao.getToday());
    }

    public MaaltijdDTO maaltijdAanDagToevoegen(LocalDate date, String naam, double calorieWaarde, double koolhydraatWaarde, double eiwitWaarde, double vetWaarde){
    ...
    public void maaltijdVerwijderen(LocalDate date, UUID maaltijdId){
